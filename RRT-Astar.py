...
class RRT:
    ...
    def add_weighted_edge(self, current_node, next_node, dist):
        self.tree.add_edge(current_node, next_node, weight = dist)
    ...
    while not queue.empty():
        ...
        if current_node == goal:        
            ...
            for next_node in graph[current_node]:
                # cost =  graph.edge_cost(current_node, next_node) 
